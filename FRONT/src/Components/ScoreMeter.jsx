...
function ScoreMeter() {
  ...
  const [performanceData, setPerformanceData] = useState({
    ...
    activeDrivers: 156,
    topPerformers: [
      { name: 'Mike Richardson', deliveries: 342, rating: 4.9, onTime: 98.5, avatar: '/src/assets/reactcg/profile.png' },
      { name: 'Lisa Kim', deliveries: 318, rating: 4.8, onTime: 97.2, avatar: '/src/assets/reactcg/profile.png' },
      { name: 'Tom Harris', deliveries: 295, rating: 4.9, onTime: 99.1, avatar: '/src/assets/reactcg/profile.png' },
      { name: 'Anna Brown', deliveries: 287, rating: 4.7, onTime: 96.8, avatar: '/src/assets/reactcg/profile.png' },
      { name: 'John Smith', deliveries: 276, rating: 4.8, onTime: 97.5, avatar: '/src/assets/reactcg/profile.png' },
    ],
  })
                ...
                <tbody>
                  {performanceData.topPerformers.map((driver, i) => (
                    <tr key={i} className="border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-3">
                          <img src={driver.avatar} alt={driver.name} className="w-10 h-10 rounded-full object-cover" onError={(e) => { e.target.src = '/src/assets/reactcg/profile.png' }} />
